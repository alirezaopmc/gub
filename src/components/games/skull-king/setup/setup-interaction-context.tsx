...
const SetupInteractionContext =
  React.createContext<SetupInteractionState | null>(null);

export function SetupInteractionProvider({
  children,
}: {
  children: React.ReactNode;
}) {
  const [crewNameFieldsBlurredOnce, setCrewNameFieldsBlurredOnce] =
  ...
  return (
    <SetupInteractionContext.Provider value={value}>
      {children}
    </SetupInteractionContext.Provider>
  );
}
