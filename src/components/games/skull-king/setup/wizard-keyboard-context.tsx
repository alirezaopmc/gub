...
const WizardKeyboardContext =
  React.createContext<WizardKeyboardContextValue | null>(null);
...
export function WizardKeyboardProvider({
  ...
  return (
    <WizardKeyboardContext.Provider value={value}>
      {children}
    </WizardKeyboardContext.Provider>
  );
}
