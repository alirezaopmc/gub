...
import {
  startingPlayerSeatForRound,
  voyageRunningTotalThroughRoundView,
        ...
        <div
          className={cn(
            ...
            showRoundScoreColumn
              ? styles.tableGridStatsWithScore
              : styles.tableGridStats,
            !showWon &&
              (showRoundScoreColumn
                ? styles.tableGridStatsWithScoreBidOnly
                : styles.tableGridStatsBidOnly),
          )}
        >
