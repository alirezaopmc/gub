...
export function VoyageNavigator() {
  ...
  const highestUnlockedRoundIndex = useRoundScoreStore(
    (s) => s.highestUnlockedRoundIndex,
  );
      ...
      <div className={styles.navigatorInner}>
        ...
        <div className={styles.navigatorLabel}>
          <div className={styles.handSizeGroup}>
            ...
            <p className={styles.handSizeCaption}>{cardsLabel} each</p>
          </div>
        ...
        <Button
          ...
          title={
            atRightLimit
              ? "Next round opens when you continue from a completed round"
              : undefined
          }
