        ...
        <Dialog.Portal>
          ...
          <Dialog.Content aria-describedby={idDesc}>
            ...
            <Dialog.Description id={idDesc}>
              This clears bids, tricks won, scores, and events for this round
              and every later round on this voyage. You still move forward from
              here using Start / Finish / Finalize as usual.
            </Dialog.Description>
