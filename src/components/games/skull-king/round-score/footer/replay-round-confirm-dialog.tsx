    ...
    <>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent aria-describedby={idDesc}>
          <DialogTitle>Redo round {roundNumber}?</DialogTitle>
          <DialogDescription id={idDesc}>
            This clears bids, tricks won, scores, and events for this round and
            every later round on this voyage. You still move forward from here
            using Start / Finish / Finalize as usual.
          </DialogDescription>
